...
I decided to look for a binary online but didn't find what I was looking for: a simple CLI script to bind to and consume messages from an exchange then writing them to STDOUT.
